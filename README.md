  ...
  <p align="center">
    <a href="https://godoc.org/github.com/moethu/engine"><img src="https://godoc.org/github.com/moethu/engine?status.svg" alt="Godoc"></img></a>
    <a href="https://goreportcard.com/report/github.com/moethu/engine"><img src="https://goreportcard.com/badge/github.com/moethu/engine"  alt="Go Report Card"/></a>
  </p>
...
Install the development files of OpenAL and Vorbis using [Homebrew](https://brew.sh/):
  ...
  ```
  git clone https://github.com/moethu/engine g3n-engine
  cd g3n-engine
  go install ./...
  ```
...
import (
	"github.com/moethu/engine/app"
	"github.com/moethu/engine/camera"
	"github.com/moethu/engine/camera/control"
	...
	"github.com/moethu/engine/light"
...
func main() {
  ...
  The complete engine API reference can be found here: [![GoDoc](https://godoc.org/github.com/moethu/engine?status.svg)](https://godoc.org/github.com/moethu/engine).

  There is also the beginning of a Getting Started Guide, and a newly created list of Guides and Tutorials:

  * [Getting Started](https://github.com/moethu/engine/wiki/Getting-Started-(WIP))
  * [Guides and Tutorials](https://github.com/moethu/engine/wiki/Guides-and-Tutorials)
